...
/*   Updated: 2022/12/20 16:27:07 by hyunjung         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Fixed::Fixed(int _value) { this->_value = _value << this->_bit; }

Fixed::Fixed(const float _value) {
    this->_value = roundf(_value * (1 << this->_bit));
}

Fixed::Fixed(const Fixed &obj) { this->_value = obj.getRawBits(); }
...
int Fixed::toInt(void) const { return this->_value >> this->_bit; }
